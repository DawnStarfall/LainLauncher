...
public class LauncherPanel extends IScreen {
	...
	private Font customFont = FontLoader.loadFont("Narrowband Prime ICG Regular.ttf", "Narrowband Prime ICG Regular", 18F);
	...
	public LauncherPanel(Pane root, GameEngine engine) {
		...
		this.usernameField.setVoidText("Ur Username");
		/** ===================== CASE MOT DE PASSE ===================== */
		...
		this.passwordField.setVoidText("Password (leave empty if no account)");
		/** ===================== BOUTON DE CONNEXION ===================== */
		this.loginButton = new LauncherButton("Log In", root);
		...
		this.loginButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				if (usernameField.getText().length() < 1) {
					new LauncherAlert("Ur name is too short, bozo",
							"We couldn't connect, or your name may be too short, silly baka!");
		...
		this.settingsButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				frame.setTitle("Change Settings");
		...
		this.microsoftButton = new LauncherButton("25 dollar haver Sign In", root);
		this.setFontSize(12.5F);
	...
	private void setFontSize(float size) {
		this.customFont = FontLoader.loadFont("Narrowband Prime ICG Regular.ttf", "Narrowband Prime ICG Regular", size);
	}
}
