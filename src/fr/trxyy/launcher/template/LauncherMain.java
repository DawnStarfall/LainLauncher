...
public class LauncherMain extends AlternativeBase {
	public static GameFolder GAME_FOLDER = new GameFolder("freeminecraft");
	private GameLinks GAME_LINKS = new GameLinks("http://10.0.0.39:2332/", "1.19.2-forge-43.1.1.json");

	private LauncherPreferences LAUNCHER_PREFS = new LauncherPreferences("LainLauncher", 880, 520, Mover.MOVE);
	...
	private Parent createContent() {
		...
		new LauncherBackground(this.GAME_ENGINE, "background.gif", contentPane);
